...
router.route('/otp-login-user').post(controller.otpLoginUser)
...
router.route('/update-appointment').put(Auth,controller.appointmentUpdate);
...
router.route('/my-appointments/:status/:id').get(Auth,controller.getMyAppointment);
router.route('/my-doctors/:id').get(Auth,controller.getMyDoctors);
router.route('/get-profile/:id').get(Auth,controller.getUserProfile);
router.route('/updateProfile/:id').put(Auth,controller.updateProfile);
