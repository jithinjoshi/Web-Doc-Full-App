...
import { Auth, DoctorAuth,checkBlockDoctor } from '../Auth/middleware.js';

const router = express.Router();

router.route('/signin').post(controller.login);
router.route('/profile/:id').get(DoctorAuth,checkBlockDoctor,controller.profile);
...
router.route('/getFullProfit/:id').get(DoctorAuth,controller.getFullPayment);
