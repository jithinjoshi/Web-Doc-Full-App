...
const FindPage = () => {
    ...
    return (
        <>
            ...
            <div class="p-6 grid grid-cols-1 gap-6 rounded-lg mt-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                    <div class="relative">
                        ...
                        <input type="search" id="default-search" class="block w-full p-4 pl-10 text-sm text-gray-900 border border-gray-300 rounded-lg bg-gray-50 focus:ring-blue-500 focus:border-blue-500 " placeholder="Search Doctors,Departments...." required onChange={(e)=>setSearchInput(e.target.value)}/>
                    </div>
                </div>
